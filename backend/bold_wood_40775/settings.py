"""
Django settings for bold_wood_40775 project.
...
ROOT_URLCONF = 'bold_wood_40775.urls'
...
WSGI_APPLICATION = 'bold_wood_40775.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "bold_wood_40775 API",
    "DESCRIPTION": "API documentation for bold_wood_40775 App",
    "VERSION": "v1",
}
